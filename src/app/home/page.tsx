...
export default async function PromoPage() {
  ...
  return (
    ...
    <div className="flex flex-col h-[100svh] w-full overflow-hidden">
      {/* Hero image layer (behind background) */}
      ...
      {/* Rounded background overlapping hero from below */}
      <div className="flex-1 flex flex-col overflow-hidden min-h-0 mt-[38svh] relative z-10 rounded-t-[40px]" style={{backgroundColor: bgColor, boxShadow: '0 -8px 32px rgba(0,0,0,0.15)'}}>
